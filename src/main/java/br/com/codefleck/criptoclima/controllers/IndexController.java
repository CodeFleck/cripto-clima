...
public class IndexController {
    ...
    String index(Model model) {
        ...
        try {
            String bitcoinFeed = rssParser.readRssFeed("https://www.google.com/alerts/feeds/12364797074637630541/8177714723373013494");
            System.out.println(bitcoinFeed);
            model.addAttribute("bitcoinNews", bitcoinFeed);
        } catch (IOException e) {
            e.printStackTrace();
